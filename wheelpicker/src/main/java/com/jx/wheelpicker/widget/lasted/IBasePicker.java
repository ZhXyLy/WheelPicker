...
public interface IBasePicker {
     ...
     * 设置滚轮Item选中监听器
     *
     * @param listener 滚轮Item选中监听器{@link com.jx.wheelpicker.widget.lasted.BasePicker.OnItemSelectedListener}
     */
    void setOnItemSelectedListener(BasePicker.OnItemSelectedListener listener);
     ...
     * @param data 数据列表
     */
    void setData(List<? extends Data> data);
     ...
     * @see com.jx.wheelpicker.widget.lasted.BasePicker.OnWheelChangeListener
     */
    void setOnWheelChangeListener(BasePicker.OnWheelChangeListener listener);
